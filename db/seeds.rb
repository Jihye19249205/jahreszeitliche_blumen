...
users = User.create!([
  { email: 'user1@test.com',
    ...
    prefecture: Prefecture.find_by(prefecture: "東京都"),
    is_deleted: false,
  ...
  { email: 'user3@test.com',
    ...
    prefecture: Prefecture.find_by(prefecture: "神奈川県"),
    is_deleted: false,
  ...
  { email: 'user4@test.com',
    ...
    prefecture: Prefecture.find_by(prefecture: "千葉県"),
    is_deleted: false,
  ...
  { email: 'user8@test.com',
    ...
    introduction: 'よろしくお願いいたします。',
    prefecture: Prefecture.find_by(prefecture: "埼玉県"),
    is_deleted: false,
...
Picture.create!([
  ...
  { user: User.find_by(nick_name: "Suzuki-Jiro"),
    season: Season.find_by(season: "秋"),
    prefecture: Prefecture.find_by(prefecture: "茨城県"),
    spot_name: 'ひたち海浜公園',
    caption: 'コキアの赤が綺麗でした。',
  ...
  { user: User.find_by(nick_name: "Suzuki-Jiro"),
    season: Season.find_by(season: "春"),
    prefecture: Prefecture.find_by(prefecture: "茨城県"),
    spot_name: 'ひたち海浜公園',
  ...
  { user: User.find_by(nick_name: "Suzuki-Hanae"),
    season: Season.find_by(season: "春"),
    prefecture: Prefecture.find_by(prefecture: "茨城県"),
    spot_name: 'ひたち海浜公園',
  ...
  { user: User.find_by(nick_name: "Tanaka-Hitoshi"),
    season: Season.find_by(season: "夏"),
    prefecture: Prefecture.find_by(prefecture: "茨城県"),
    spot_name: '昭和記念公園',
  ...
  { user: User.find_by(nick_name: "Mochizuki-Yuko"),
    season: Season.find_by(season: "春"),
    prefecture: Prefecture.find_by(prefecture: "東京都"),
    spot_name: '新宿御苑',
  ...
  { user: User.find_by(nick_name: "Kinoshita-Hokuto"),
    season: Season.find_by(season: "春"),
    prefecture: Prefecture.find_by(prefecture: "東京都"),
    spot_name: '根津神社',
  ...
  { user: User.find_by(nick_name: "Murata-Shoji"),
    season: Season.find_by(season: "春"),
    prefecture: Prefecture.find_by(prefecture: "東京都"),
    spot_name: '根津神社',
  ...
  { user: User.find_by(nick_name: "Yamamoto-Noriko"),
    season: Season.find_by(season: "秋"),
    prefecture: Prefecture.find_by(prefecture: "埼玉県"),
    spot_name: '巾着田',
  ...
  { user: User.find_by(nick_name: "Hirayama-Chie"),
    season: Season.find_by(season: "冬"),
    prefecture: Prefecture.find_by(prefecture: "茨城県"),
    spot_name: '筑波山',
